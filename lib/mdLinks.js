...
var mdLinks = function mdLinks(route, options) {
  return new Promise(function (resolve, reject) {
    if ((0, _pathController.isAbsolute)(route)) {
      if (options) {
        resolve((0, _validate.validateArr)((0, _directoryController.readDir)(route))).then(function (res) {
          console.log(res);
        });
      } else {
      ...
      resolve(mdLinks((0, _pathController.isRelative)(route), options)).then(function (res) {
        console.log(res);
      });
    }
  });
